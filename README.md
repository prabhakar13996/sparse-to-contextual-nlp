...
How do TF-IDF, BiLSTM, and DistilBERT compare in classification performance?

How does training-data size affect the performance of each approach?
...
01_dataset_audit.ipynb — inspect dataset quality, duplicates, labels, and text statistics.

02_dataset_preparation.ipynb — remove conflicting/duplicate texts and create the stratified train/validation/test split.

03_tfidf_baseline.ipynb — train and evaluate the TF-IDF + Logistic Regression baseline.

04_bilstm.ipynb — train and evaluate the BiLSTM model.

05_distilbert.ipynb — fine-tune and evaluate DistilBERT.

06_data_efficiency.ipynb — evaluate performance using different training-data fractions.

07_error_analysis.ipynb — analyze class-level performance, confusion patterns, and text-length errors.

08_poster_figures.ipynb — generate the final comparison tables and poster figures.
...
Place the prepared datasets in data/prepared/.

Run the notebooks in numerical order.

Use 08_poster_figures.ipynb to regenerate the final figures and summary table.
